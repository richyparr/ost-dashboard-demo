...
const mockFiles = [
  ...
  { id: 6, name: 'Social Media Calendar.xlsx', type: 'xlsx', size: '890 KB', uploadedBy: 'James Chen', date: 'Jan 9, 2026' },
  { id: 7, name: 'Client Contracts Archive.pdf', type: 'pdf', size: '12.3 MB', uploadedBy: 'Maria Santos', date: 'Jan 8, 2026' },
  { id: 8, name: 'Team Performance Review.docx', type: 'docx', size: '245 KB', uploadedBy: 'Sofia Rodriguez', date: 'Jan 7, 2026' },
];
...
const mockLeaveRequests = [
  ...
  { id: 2, employee: 'James Chen', initials: 'JC', dates: 'Feb 20 - Feb 21, 2026', days: 2, reason: 'Personal Leave - Moving house', status: 'pending', notes: '' },
  { id: 3, employee: 'Sofia Rodriguez', initials: 'SR', dates: 'Jan 8 - Jan 9, 2026', days: 2, reason: 'Sick Leave', status: 'approved', notes: 'Approved - Feel better!' },
  { id: 4, employee: 'James Chen', initials: 'JC', dates: 'Jan 3, 2026', days: 1, reason: 'Personal Leave - Medical appointment', status: 'approved', notes: 'Approved' },
  { id: 5, employee: 'Maria Santos', initials: 'MS', dates: 'Dec 23 - Dec 27, 2025', days: 3, reason: 'Annual Leave - Christmas break', status: 'approved', notes: 'Enjoy the holidays!' },
];
...
const mockVARequests = [
  ...
  { id: 4, role: 'Social Media Manager', skills: 'Instagram, LinkedIn, Content scheduling, Analytics', hours: '25h/wk', startDate: 'Mar 1, 2026', status: 'submitted', submitted: 'Jan 14, 2026' },
  { id: 5, role: 'Customer Service Rep', skills: 'Zendesk, Live chat, Email support, CRM', hours: '40h/wk', startDate: 'Feb 1, 2026', status: 'in-review', submitted: 'Jan 8, 2026' },
];
  ...
  <div className="content-area">
    ...
    <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(4, 1fr)', marginBottom: 24 }}>
      ...
      <div className="stat-card">
        ...
        <div className="stat-value">17.5 MB</div>
      </div>
      <div className="stat-card">
        <div className="stat-card-header">
